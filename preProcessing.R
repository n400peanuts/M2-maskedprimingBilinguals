...
write.table(masterFile, "C:/Users/Eva Viviani/OneDrive/Documenti/SISSA - Experiments/Masked Priming/bilingualism/Output/Sumup RT+Proficiency/masterFile.txt", quote = F, col.names = T, row.names = F)
