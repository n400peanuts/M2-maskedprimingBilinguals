...
We fit a final model with a specific matrix of comparisons in order to get the estimates for each contrast of morphType by relatedness:

```{r itaglmer2_estimate, eval=FALSE}
itaglmer2_estimate<- glmer(rt ~  morphType + relatedness:morphType + freqTarget + (1|subject) + (1|target), data= dataIta, family=Gamma(link="identity"), control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)));
```

```{r table of estimates for itaglmer2}
knitr::kable(round(summary(itaglmer2_estimate)$coefficients,4))
```
...
```{r}
itaglmer_phonFlu_anova <- car::Anova(itaglmer_phonFlu)
itaglmer_phonFlu_anova
```
...
```{r}
itaglmer_phonCom_anova <- car::Anova(itaglmer_phonCom)
itaglmer_phonCom_anova
```

Unfortunately the other proficiency tests the model don't converge, so we don't interpret those.
...
The model itaglmer2 shows a significant interaction between relatedness and morphtype [$\chi^2$ = `r round(itaglmer2.anova$Chisq[4], 2)`, $Df$ = `r itaglmer2.anova$Df[4]`, *p*  $<$ 0.0001], such that among related trials there were faster reaction times to orthographic trials compared to opaque trials [$\beta$ = `r round(modelsum2$coefficients, 2)[6,1]`, $Std.Error$ = `r round(modelsum2$coefficients[6,2],2)`, $t$ = `r round(modelsum2$coefficients[6,3],2)`, *p*  $<$ 0.0001], and to transparent trials [$\beta$ = `r round(modelsum2$coefficients, 2)[7,1]`, $Std.Error$ = `r round(modelsum2$coefficients[7,2],2)`, $t$ = `r round(modelsum2$coefficients[7,3],2)`, *p*  $<$ 0.0001]. By setting the base contrast to opaque trials, itaglmer2c shows that opaque trials are faster than transparent trials [$\beta$ = `r round(modelsum2c$coefficients, 2)[7,1]`, $Std.Error$ = `r round(modelsum2c$coefficients[7,2],2)`, $t$ = `r round(modelsum2c$coefficients[7,3],2)`, *p*  $<$ 0.0001]. Estimate for the orthographic condition by relatedness: [$\beta$ = `r round(summary(itaglmer2_estimate)$coefficients,4)[6,1]`, $Std.Error$ = `r round(summary(itaglmer2_estimate)$coefficients[6,2],2)`, $t$ = `r round(summary(itaglmer2_estimate)$coefficients[6,3],2)`, *p* = 0.52], 
for the opaque condition by relatedness: [$\beta$ = `r round(summary(itaglmer2_estimate)$coefficients,4)[5,1]`, $Std.Error$ = `r round(summary(itaglmer2_estimate)$coefficients[5,2],2)`, $t$ = `r round(summary(itaglmer2_estimate)$coefficients[5,3],2)`, *p* < 0.0001], for the transparent condition by relatedness: [$\beta$ = `r round(summary(itaglmer2_estimate)$coefficients,4)[7,1]`, $Std.Error$ = `r round(summary(itaglmer2_estimate)$coefficients[7,2],2)`, $t$ = `r round(summary(itaglmer2_estimate)$coefficients[7,3],2)`, *p* < 0.0001].
...
Like we have done for the itaglmer2, we now fit again a model with the specific interaction we are looking for, that it, morphType by relatedness:
```{r engglmer2_estimate, eval=FALSE}
engglmer2_estimate <- glmer(rt ~ morphType + relatedness:morphType + freqTarget + lengthTarget + (1|subject) + (1|target), data = dataEng, family=Gamma(link="identity"), control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
```

```{r table of estimates for engglmer2}
knitr::kable(round(summary(engglmer2_estimate)$coefficients,4))
```


# Summary of the results for ENG dataset

The model engglmer2 shows a significant interaction between relatedness and morphtype [$\chi^2$ = `r round(engglmer2.anova$Chisq[5], 2)`, $Df$ = `r engglmer2.anova$Df[5]`, *p*  $<$ 0.0001], such that among related trials there were faster reaction times to orthographic trials compared to opaque trials, although only marginally significant [$\beta$ = `r round(engglmer2.modelsum$coefficients, 2)[7,1]`, $Std.Error$ = `r round(engglmer2.modelsum$coefficients[7,2],2)`, $t$ = `r round(engglmer2.modelsum$coefficients[7,3],2)`, *p*  = `r round(engglmer2.modelsum$coefficients[7,4],4)`], and to transparent trials [$\beta$ = `r round(engglmer2.modelsum$coefficients, 2)[8,1]`, $Std.Error$ = `r round(engglmer2.modelsum$coefficients[8,2],2)`, $t$ = `r round(engglmer2.modelsum$coefficients[8,3],2)`, *p*  $<$ 0.0001]. By setting the base contrast to opaque trials, engglmer2c shows that opaque trials are faster than transparent trials [$\beta$ = `r round(engglmer2c.modelsum$coefficients, 2)[8,1]`, $Std.Error$ = `r round(engglmer2c.modelsum$coefficients[8,2],2)`, $t$ = `r round(engglmer2c.modelsum$coefficients[8,3],2)`, *p*  $<$ 0.0002]. Estimate for the orthographic condition by relatedness: [$\beta$ = `r round(summary(engglmer2_estimate)$coefficients,4)[7,1]`, $Std.Error$ = `r round(summary(engglmer2_estimate)$coefficients[7,2],2)`, $t$ = `r round(summary(engglmer2_estimate)$coefficients[7,3],2)`, *p* < 0.0001], 
for the opaque condition by relatedness: [$\beta$ = `r round(summary(engglmer2_estimate)$coefficients,4)[6,1]`, $Std.Error$ = `r round(summary(engglmer2_estimate)$coefficients[6,2],2)`, $t$ = `r round(summary(engglmer2_estimate)$coefficients[6,3],2)`, *p* < 0.0001], for the transparent condition by relatedness: [$\beta$ = `r round(summary(engglmer2_estimate)$coefficients,4)[8,1]`, $Std.Error$ = `r round(summary(engglmer2_estimate)$coefficients[8,2],2)`, $t$ = `r round(summary(engglmer2_estimate)$coefficients[8,3],2)`, *p* < 0.0001].
...
The model crossglmer.anova shows a significant 3-way interaction between relatedness:morphType:language [$\chi^2$ = `r round(crossglmer.anova$Chisq[9], 2)`, $Df$ = `r crossglmer.anova$Df[9]`, *p*  $<$ 0.0001], such that among Italian and English related trials there were faster reaction times to orthographic trials compared to opaque trials [$\beta$ = `r round(crossglmer.modelsum$coefficients, 2)[7,1]`, $Std.Error$ = `r round(crossglmer.modelsum$coefficients, 2)[7,2]`, $t$ = `r round(crossglmer.modelsum$coefficients, 2)[7,3]`, *p*  = .0002], and to transparent trials [$\beta$ = `r round(crossglmer.modelsum$coefficients, 2)[8,1]`, $Std.Error$ = `r round(crossglmer.modelsum$coefficients, 2)[8,2]`, $t$ = `r round(crossglmer.modelsum$coefficients, 2)[8,3]`, *p*  $<$ 0.0001]. By setting the base contrast to opaque trials, crossglmerc.anova shows that opaque trials are faster than transparent trials [$\beta$ = `r round(crossglmerc.modelsum$coefficients, 2)[9,1]`, $Std.Error$ = `r round(crossglmerc.modelsum$coefficients, 2)[9,2]`, $t$ = `r round(crossglmerc.modelsum$coefficients, 2)[9,3]`, *p*  $<$ 0.0001].
...
```{r}
multicon::splithalf.r(pptFeatures[,6:12], sims = 5000, graph = T);

```
Get Cronbach's alpha as well:
```{r}
...
We fit a model with the specific relatedness:morphType:phonemicFluency interaction:

```{r proficiencyglmer1_estimate, eval=FALSE}
proficiencyglmer1_estimate <- glmer(rt ~ relatedness  + morphType + phonemicFluency + relatedness:morphType + morphType:phonemicFluency + relatedness:morphType:phonemicFluency + lengthTarget + freqTarget + (1|subject) 
                            + (1|target), data = dataEng, family=Gamma(link="identity"), control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)));

```

```{r table of estimates for proficiencyglmer1}
knitr::kable(round(summary(proficiencyglmer1_estimate)$coefficients,4))
```
...
We fit a model with the specific relatedness:morphType:phonemicComprehension interaction:
...
```{r table of estimates for proficiencyglmer2}
...
We fit a model with the specific relatedness:morphType:morphComprehension interaction:
...
```{r table of estimates for proficiencyglmer3}
...
We fit a model with the specific relatedness:morphType:spelling interaction:
```{r proficiencyglmer4_estimate, eval=FALSE}
proficiencyglmer4_estimate<- glmer(rt ~ relatedness  + morphType + spelling + relatedness:morphType + morphType:spelling + relatedness:morphType:spelling + lengthTarget + freqTarget + (1|subject) + (1|target), 
                                data = dataEng, family=Gamma(link="identity"), 
                                control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)));

```

```{r table of estimates for proficiencyglmer4}
knitr::kable(round(summary(proficiencyglmer4_estimate)$coefficients,4))
```
...
We fit a model with the specific relatedness:morphType:readingComprehension:
```{r proficiencyglmer5_estimate, eval=FALSE}
proficiencyglmer5_estimate<- glmer(rt ~ relatedness  + morphType + readingComprehension + relatedness:morphType + morphType:readingComprehension + relatedness:morphType:readingComprehension + lengthTarget + freqTarget + (1|subject) + (1|target), 
                                data = dataEng, family=Gamma(link="identity"), 
                                control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)));

```

```{r table of estimates for proficiencyglmer5}
knitr::kable(round(summary(proficiencyglmer5_estimate)$coefficients,4))
```
...
We fit a model with the specific relatedness:morphType:vocabulary:
...
```{r table of estimates for proficiencyglmer6}
...
We fit a model with the specific relatedness:morphType:oralComprehension:
```{r proficiencyglmer7_estimate, eval=FALSE}
proficiencyglmer7_estimate<- glmer(rt ~ relatedness  + morphType + oralComprehension + relatedness:morphType + morphType:oralComprehension + relatedness:morphType:oralComprehension + lengthTarget + freqTarget + (1|subject) + (1|target), 
                                data = dataEng, family=Gamma(link="identity"), 
                                control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)));

```

```{r table of estimates for proficiencyglmer7}
knitr::kable(round(summary(proficiencyglmer7_estimate)$coefficients,4))
```


# Summary of the results for language proficiency and priming

- The splith-half reliability run over 5000 splits showed an average split-half reliability (Spearman-Brown corrected) of 0.83, with scores varying from .6 to .8. 

- Each sub-test improved goodness of fit when added to the base model formula, i.e., accuracy ~ relatedness * morphType

We assessed each proficiency score separately and we report the results one by one:

- **Phonemic fluency:** the model proficiencyglmer1.anova shows a non significant 3-way interaction between relatedness:morphType:phonemicFluency [$\chi^2$ = `r round(proficiencyglmer1.anova$Chisq[9], 2)`, $Df$ = `r proficiencyglmer1.anova$Df[9]`, *p*  = 0.1631]

- **Phonemic Comprehension:** the model proficiencyglmer2.anova shows a robust 3-way interaction between relatedness:morphType:phonemicComprehension [$\chi^2$ = `r round(proficiencyglmer2.anova$Chisq[9], 2)`, $Df$ = `r proficiencyglmer2.anova$Df[9]`, *p*  $<$ 0.0001]. Priming in the orthographic condition shrinks at higher scores [$\beta$ = `r round(summary(proficiencyglmer2_estimate)$coefficients,3)[12,1]`, $Std.Error$ = `r round(summary(proficiencyglmer2_estimate)$coefficients,3)[12,2]`, $t$ = `r round(summary(proficiencyglmer2_estimate)$coefficients,3)[12,3]`, *p* $<$ .0001], and it differs from opaque priming [$\beta$ = `r round(proficiencyglmer2.modelsum$coefficients, 4)[13]`, $Std.Error$ = `r round(proficiencyglmer2.modelsum$coefficients, 4)[13,2]`, $t$ = `r round(proficiencyglmer2.modelsum$coefficients, 4)[13,3]`, *p* $<$ .0001], and transparent priming [$\beta$ = `r round(proficiencyglmer2.modelsum$coefficients, 4)[14]`, $Std.Error$ = `r round(proficiencyglmer2.modelsum$coefficients, 4)[14,2]`, $t$ = `r round(proficiencyglmer2.modelsum$coefficients, 4)[14,3]`, *p* = .0006]. 
Opaque priming steepens at higher proficiency [$\beta$ = `r round(summary(proficiencyglmer2_estimate)$coefficients,4)[13]`, $Std.Error$ = `r round(summary(proficiencyglmer2_estimate)$coefficients,4)[13,2]`, $t$ = `r round(summary(proficiencyglmer2_estimate)$coefficients,4)[13,3]`, *p* = `r round(summary(proficiencyglmer2_estimate)$coefficients,4)[13,4]`] while transparent priming instead remains identical across the board [$\beta$ = `r round(summary(proficiencyglmer2_estimate)$coefficients,4)[14]`, $Std.Error$ = `r round(summary(proficiencyglmer2_estimate)$coefficients,4)[14,2]`, $t$ = `r round(summary(proficiencyglmer2_estimate)$coefficients,4)[14,3]`, *p* = `r round(summary(proficiencyglmer2_estimate)$coefficients,4)[14,4]`].
The model set to opaque contrast however shows no difference between opaque and transparent conditions [$\beta$ = `r round(proficiencyglmer2b.modelsum$coefficients, 4)[14]`, $Std.Error$ = `r round(proficiencyglmer2b.modelsum$coefficients, 4)[14,2]`, $t$ = `r round(proficiencyglmer2b.modelsum$coefficients, 4)[14,3]`, *p* = .45].

- **Morphological awareness:** the model proficiencyglmer3.anova shows a robust 3-way interaction between relatedness:morphType:morphComprehension [$\chi^2$ = `r round(proficiencyglmer3.anova$Chisq[9], 2)`, $Df$ = `r proficiencyglmer3.anova$Df[9]`, *p*  = 0.0002]. Priming in the orthographic condition follows a decreasing pattern at growing morphological awareness, like in phonemic comprehension [$\beta$ = `r round(summary(proficiencyglmer3_estimate)$coefficients,3)[12,1]`, $Std.Error$ = `r round(summary(proficiencyglmer3_estimate)$coefficients,3)[12,2]`, $t$ = `r round(summary(proficiencyglmer3_estimate)$coefficients,3)[12,3]`, *p* $<$ .0001]. This decreasing pattern is statistically different from opaque priming that shows to be faster than orthographic priming [$\beta$ = -`r round(proficiencyglmer3.modelsum$coefficients, 4)[13]`, $Std.Error$ = `r round(proficiencyglmer3.modelsum$coefficients, 4)[13,2]`, $t$ = `r round(proficiencyglmer3.modelsum$coefficients, 4)[13,3]`, *p* = .0001]. However, orthographic priming does not show to be different from transparent priming  [$\beta$ = `r round(proficiencyglmer3.modelsum$coefficients, 4)[14]`, $Std.Error$ = `r round(proficiencyglmer3.modelsum$coefficients, 4)[14,2]`, $t$ = `r round(proficiencyglmer3.modelsum$coefficients, 4)[14,3]`, *p* = .32], while instead the model shows a significant difference between opaque and transparent priming [$\beta$ = `r round(proficiencyglmer3b.modelsum$coefficients, 4)[14]`, $Std.Error$ = `r round(proficiencyglmer3b.modelsum$coefficients, 4)[14,2]`, $t$ = `r round(proficiencyglmer3b.modelsum$coefficients, 4)[14,3]`, *p* $<$ .0001]. Estimate of opaque priming [$\beta$ = `r round(summary(proficiencyglmer3_estimate)$coefficients,3)[13,1]`, $Std.Error$ = `r round(summary(proficiencyglmer3_estimate)$coefficients,3)[13,2]`, $t$ = `r round(summary(proficiencyglmer3_estimate)$coefficients,3)[13,3]`, *p* $<$ .0001], and transparent priming [$\beta$ = `r round(summary(proficiencyglmer3_estimate)$coefficients,3)[14,1]`, $Std.Error$ = `r round(summary(proficiencyglmer3_estimate)$coefficients,3)[14,2]`, $t$ = `r round(summary(proficiencyglmer3_estimate)$coefficients,3)[14,3]`, *p* $<$ .0001].

- **Spelling:** the model proficiencyglmer4.anova shows a non significant 3-way interaction between relatedness:morphType:spelling [$\chi^2$ = `r round(proficiencyglmer4.anova$Chisq[9], 2)`, $Df$ = `r proficiencyglmer4.anova$Df[9]`, *p*  = 0.0913].

- **Reading comprehension:** the model proficiencyglmer5.anova shows a non significant 3-way interaction between relatedness:morphType:readingComprehension [$\chi^2$ = `r round(proficiencyglmer5.anova$Chisq[9], 2)`, $Df$ = `r proficiencyglmer5.anova$Df[9]`, *p*  = 0.4750].

- **Vocabulary:** the model proficiencyglmer6.anova shows a robust 3-way interaction between relatedness:morphType:vocabulary [$\chi^2$ = `r round(proficiencyglmer6.anova$Chisq[9], 2)`, $Df$ = `r proficiencyglmer6.anova$Df[9]`, *p*  < 0.0001]. Greater facilitatory priming for transparent than orthographic [$\beta$ = `r round(proficiencyglmer6.modelsum$coefficients, 4)[14]`, $Std.Error$ = `r round(proficiencyglmer6.modelsum$coefficients, 4)[14,2]`, $t$ = `r round(proficiencyglmer6.modelsum$coefficients, 4)[14,3]`, *p* = .0001] and opaque priming [$\beta$ = `r round(proficiencyglmer6b.modelsum$coefficients, 4)[14]`, $Std.Error$ = `r round(proficiencyglmer6b.modelsum$coefficients, 4)[14,2]`, $t$ = `r round(proficiencyglmer6b.modelsum$coefficients, 4)[14,3]`, *p* = .0002] along the whole vocabulary spectrum. Opaques and orthographic priming shrink at higher scores, [opaque: $\beta$ = `r round(summary(proficiencyglmer6_estimate)$coefficients,3)[12,1]`, $Std.Error$ = `r round(summary(proficiencyglmer6_estimate)$coefficients,3)[12,2]`, $t$ = `r round(summary(proficiencyglmer6_estimate)$coefficients,3)[12,3]`, *p* $<$ .0001, orthographic: $\beta$ = `r round(summary(proficiencyglmer6_estimate)$coefficients,3)[13,1]`, $Std.Error$ = `r round(summary(proficiencyglmer6_estimate)$coefficients,3)[13,2]`, $t$ = `r round(summary(proficiencyglmer6_estimate)$coefficients,3)[13,3]`, *p* $<$ .0001]. Model set to orthographic contrast shows also that opaque and orthographic priming differs significantly, [$\beta$ = `r round(proficiencyglmer6.modelsum$coefficients, 4)[13]`, $Std.Error$ = `r round(proficiencyglmer6.modelsum$coefficients, 4)[13,2]`, $t$ = `r round(proficiencyglmer6.modelsum$coefficients, 4)[13,3]`, *p* = .0009].

- **Oral comprehension:** the model proficiencyglmer7.anova shows a non significant 3-way interaction between relatedness:morphType:readingComprehension [$\chi^2$ = `r round(proficiencyglmer7.anova$Chisq[9], 2)`, $Df$ = `r proficiencyglmer7.anova$Df[9]`, *p*  = 0.698].
...
# Does AoA interact with priming?

### AoA 1 - Age first exposed to English
Anova of aoaglmer1 - ortographic contrast
```{r}
aoaglmer1.anova
```
...
We fit a model with the specific relatedness:morphType:AoA:
```{r aoaglmer1_estimate, eval=FALSE}
aoaglmer1_estimate<- glmer(rt ~ relatedness  + morphType + aoa1.Aoa + relatedness:morphType + morphType:aoa1.Aoa + relatedness:morphType:aoa1.Aoa + lengthTarget + freqTarget + (1|subject) + (1|target), 
                                data = dataEng, family=Gamma(link="identity"), 
                                control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)));

```

```{r table of estimates for aoaglmer1}
knitr::kable(round(summary(aoaglmer1_estimate)$coefficients,4))
```


### AoA 2 - Daily usage of English (L2)
...
We fit a model with the specific relatedness:morphType:AoA2.usage:
```{r aoaglmer2_estimate, eval=FALSE}
aoaglmer2_estimate<- glmer(rt ~ relatedness  + morphType + aoa2.usage + relatedness:morphType + morphType:aoa2.usage + relatedness:morphType:aoa2.usage + lengthTarget + freqTarget + (1|subject) + (1|target), 
                                data = dataEng, family=Gamma(link="identity"), 
                                control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)));

```

```{r table of estimates for aoaglmer2}
knitr::kable(round(summary(aoaglmer2_estimate)$coefficients,4))
```



### AoA 5 - Self rated proficiency
...
We fit a model with the specific relatedness:morphType:aoa5.selfRatedProf:
```{r aoaglmer5_estimate, eval=FALSE}
aoaglmer5_estimate<- glmer(rt ~ relatedness  + morphType + aoa5.selfRatedProf + relatedness:morphType + morphType:aoa5.selfRatedProf + relatedness:morphType:aoa5.selfRatedProf + lengthTarget + freqTarget + (1|subject) + (1|target), 
                                data = dataEng, family=Gamma(link="identity"), 
                                control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)));

```

```{r table of estimates for aoaglmer5}
knitr::kable(round(summary(aoaglmer5_estimate)$coefficients,4))
```


# Summary of the results for the AoA and priming

- **AoA1 - age of first exposure to English:** Model aoaglmer1.anova revealed a significant three-way interaction between proper AoA, prime relatedness and morphType [$\chi^2$ = `r round(aoaglmer1.anova$Chisq[8], 2)`, $Df$ = `r aoaglmer1.anova$Df[8]`, *p*  < 0.0001], indicating that the age of first exposure to English modulates priming. Only transparent primes seems to yield solid facilitation across the AoA spectrum compared to orthographic, [$\beta$ = `r round(aoaglmer1.modelsum$coefficients[13], 3)`, $Std.Error$ = `r round(aoaglmer1.modelsum$coefficients[13,2], 3)`, $t$ = `r round(aoaglmer1.modelsum$coefficients[13,3], 3)`, *p* $<$ .0001] and opaque pairs, [$\beta$ = `r round(aoaglmer1c.modelsum$coefficients[13], 3)`, $Std.Error$ = `r round(aoaglmer1c.modelsum$coefficients[13,2], 3)`, $t$ = `r round(aoaglmer1c.modelsum$coefficients[13,3], 3)`, *p* $<$ .0001] while there is no difference between opaque and orthographic, $\beta=-.8, t=-0.6, p=.54$.

- **AoA2 - Daily use of English:** Model aoaglmer2.anova revealed a significant three-way interaction between daily use of English, prime relatedness and morphType [$\chi^2$ = `r round(aoaglmer2.anova$Chisq[8], 2)`, $Df$ = `r aoaglmer2.anova$Df[8]`, *p*  < 0.0001]. Transparent primes show greater facilitatory priming than orthographic primes, [$\beta$ = `r round(aoaglmer2.modelsum$coefficients[13], 3)`, $Std.Error$ = `r round(aoaglmer2.modelsum$coefficients[13,2], 3)`, $t$ = `r round(aoaglmer2.modelsum$coefficients[13,3], 3)`, *p* $<$ .0001], but not than opaque primes, [$\beta$ = `r round(aoaglmer2c.modelsum$coefficients[13], 3)`, $Std.Error$ = `r round(aoaglmer2c.modelsum$coefficients[13,2], 3)`, $t$ = `r round(aoaglmer2c.modelsum$coefficients[13,3], 3)`, *p* = .16]. Opaque priming is greater than orthographic, [$\beta$ = `r round(aoaglmer2.modelsum$coefficients[12], 3)`, $Std.Error$ = `r round(aoaglmer2.modelsum$coefficients[12,2], 3)`, $t$ = `r round(aoaglmer2.modelsum$coefficients[12,3], 3)`, *p* $<$ .0001].

- **AoA5 - Self rated proficiency:** Model aoaglmer5.anova revealed a significant three-way interaction between daily use of English, prime relatedness and morphType [$\chi^2$ = `r round(aoaglmer5.anova$Chisq[8], 2)`, $Df$ = `r aoaglmer5.anova$Df[8]`, *p*  < 0.0001]. Transparent and opaque primes bring greater facilitation than orthographic controls, [transparent: $\beta$ = `r round(aoaglmer5.modelsum$coefficients[13], 3)`, $Std.Error$ = `r round(aoaglmer5.modelsum$coefficients[13,2], 3)`, $t$ = `r round(aoaglmer5.modelsum$coefficients[13,3], 3)`, *p* $<$ .0001, opaque: $\beta$ = `r round(aoaglmer5.modelsum$coefficients[12], 3)`, $Std.Error$ = `r round(aoaglmer5.modelsum$coefficients[12,2], 3)`, $t$ = `r round(aoaglmer5.modelsum$coefficients[12,3], 3)`, *p* $<$ .0001]. No difference between opaque and transparent pairs, [$\beta$ = `r round(aoaglmer5c.modelsum$coefficients[13], 3)`, $Std.Error$ = `r round(aoaglmer5c.modelsum$coefficients[13,2], 3)`, $t$ = `r round(aoaglmer5c.modelsum$coefficients[13,3], 3)`, *p* = .86].
...
```
```{r osc1 modelsum}
knitr::kable(round(osc1.modelsum$coefficients, 4))
...
```
```{r osc2 modelsum}
knitr::kable(round(osc2.modelsum$coefficients, 4))
...
```
```{r osc4 modelsum}
knitr::kable(round(osc4.modelsum$coefficients, 4))

```

# Summary of results for OSC by proficiency
Among proficiency subtests, OSC interacts with phonemic fluency as shown by the osc1.anova model, [$\chi^2$ = `r round(osc1.anova$Chisq[9], 2)`, $Df$ = `r osc1.anova$Df[9]`, *p*  < 0.0001]. Vocabulary as shown by the osc2.model, [$\chi^2$ = `r round(osc2.anova$Chisq[9], 2)`, $Df$ = `r osc2.anova$Df[9]`, *p*  < 0.0001] and morphological comprehension in the osc4.anova model [$\chi^2$ = `r round(osc4.anova$Chisq[9], 2)`, $Df$ = `r osc4.anova$Df[9]`, *p*  < 0.0001].
...
saveRDS(aoaglmer5_estimate, paste(localGitDir, "/LMMs and GLMMs/aoaglmer5_estimate.rds",sep = ""))
saveRDS(proficiencyglmer7_estimate, paste(localGitDir, "/LMMs and GLMMs/proficiencyglmer7_estimate.rds",sep = ""))
...
## Figure 6 - Scores distributions in the AoA questionnaire
...
## Figure 7 - Interaction by AoA1 by relatedness and morphtype
...
## Figure 8 - Interaction by AoA2 by relatedness and morphtype
...
## Figure 9 - Interaction by AoA5 by relatedness and morphtype
...
## Figure 11 - OSC by phonemic fluency by relatedness
...
## Figure 12 - OSC by vocabulary by relatedness
...
## Figure 13 - OSC by morphComprehension by relatedness
